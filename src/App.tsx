...
import './App.css';
import CarouselComponent from "./components/carroucel_componentes";
import Calendar from "./components/calendar";
import Jurados from "./components/jurados";
import NewsLetter from "./components/formNewslleter"
...
function App() {
  ...
  const [videoUrl, setVideoUrl] = useState(
    "https://www.youtube.com/embed/FY8MtBxkKQo"
  );
  ...
  return (
    <div className="App">
      <Helmet>
        ...
        <link rel="canonical" href="hhttps://domreality.com.br" />
        <meta
          name="description"
        ...
        >
          ...
          <Grid item xs={10}>
            <Box mb={10}>
              <h2>
                Vote no seu  
                <span style={{ color: "#ff15a4" }}> candidato</span> preferido!
                <br />
              </h2>
              <h3>
                E aí, quem você quer levar direto para final?
              </h3>
            </Box>
          </Grid>
        </Grid>
      ...
      <main id="main">
        <section id="juradosReality" style={{ backgroundColor: "#2b2080" }}>
